...
<span class="news-badge">New</span> Supported by CIE-Tencent Doctoral Research Incentive Project (混元学者/中国电子学会—腾讯博士生科研激励计划).

<span class="news-badge">New</span> Selected for the Tencent PROJECT UP Talent Program (腾讯青云计划).

<span class="news-badge">New</span> Selected for the 2026 Tencent Rhino-Bird Research Elite Program (犀牛鸟精英人才计划).

## Research Interests
<ul class="research-interests">
  <li><strong>Trustworthy Machine Learning</strong><br>Safety, Privacy, Security and etc.</li>
  <li><strong>Cyberspace Security</strong><br>Software security, Network security, IoT security and etc.</li>
</ul>
...
<div class="contact-card">
  <p><strong>Email:</strong> yingzonghao20[AT]mails[DOT]ucas[DOT]edu[DOT]cn, yingzonghao[AT]buaa[DOT]edu[DOT]cn</p>
  <p><strong>Address:</strong> No.37 Xueyuan Road, Beijing, China</p>
</div>
...
<div class="honor-banner">
  ...
  <ul class="honor-banner-list">
    <li><span class="news-badge">New</span> 07/2026 Supported by CIE-Tencent Doctoral Research Incentive Project (混元学者/中国电子学会—腾讯博士生科研激励计划).</li>
    <li><span class="news-badge">New</span> 06/2026 Selected for the Tencent PROJECT UP Talent Program (腾讯青云计划).</li>
    <li><span class="news-badge">New</span> 05/2026 Selected for the 2026 Tencent Rhino-Bird Research Elite Program (犀牛鸟精英人才计划).</li>
  </ul>
</div>
...
<ul class="news-list">
  ...
  <li>AgentSafety-Papers: A daily-updated tracker of LLM Agent security papers on arXiv, with keyword-based smart classification. <a href="https://github.com/NY1024/AgentSafety-Papers" target="_blank" class="news-link news-link-github">GitHub</a></li>
  <li>SecAI_Radar: Tracking AI security papers from top-tier AI &amp; security conferences (CCF-A and above), filtered by keywords. <a href="https://ny1024.github.io/SecAI_Radar/" target="_blank" class="news-link news-link-github">Project</a> <a href="https://github.com/NY1024/SecAI_Radar" target="_blank" class="news-link news-link-github">GitHub</a></li>
  ...
  <li>06/2023 I obtained my M.Sc from Chinese Academy of Sciences.</li>
</ul>
</div>
